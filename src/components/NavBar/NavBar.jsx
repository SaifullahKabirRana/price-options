...
const NavBar = () => {
    ...
    return (
        <nav className="p-6">
            ...
            <ul className={`md:flex md:gap-4 absolute md:static bg-stone-100 md:bg-white px-4 py-2 rounded-xl text-black font-medium shadow-xl md:shadow-none border border-white
